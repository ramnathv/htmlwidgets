...
The **[htmlwidgets](https://cran.r-project.org/web/packages/htmlwidgets/index.html)** package provides a framework for creating R bindings to JavaScript libraries. HTML Widgets can be:
