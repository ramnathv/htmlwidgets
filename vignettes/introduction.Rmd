...
TODO:
  ...
  - Additional exposition in widget sizing section
  - Section on widget instance data
  - Section on creating your own widgets
  - Remove or revise sizing vignette
  - Solicit feedback/testing 
-->
...
Note the convetion that the JavaScript, YAML, and other dependencies are all contained within the `inst/htmlwidgets` directory.
...
Let's extend our knob widget to handle sizing intelligently (more explanation here)
