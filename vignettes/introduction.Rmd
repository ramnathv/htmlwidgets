...
ui = shinyUI(fluidPage(
  ...
  knobOutput('gauge', width = 250, height = 200)
))
...
Let's extend our knob widget to handle sizing intelligently. First, we'll tweak the default sizing policy
...
```r
knob <- function(title, value, min, max, step = 1, 
