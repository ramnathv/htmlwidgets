...
In the case of the **knob** widget, the default sizing policy works fine (i.e. treat the widget like an R plot) however dynamic sizing requires a custom `resize` method. The details of this aren't provided here (see the [Sizing](Sizing.Rmd) vignette for all of the details).
